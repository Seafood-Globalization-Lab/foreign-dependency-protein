  ...
  labs(x = "",
   ...
   ylim(0,100) +
    ...
    linetype = guide_legend(
      override.aes = list(size = 0.6),  # Shrinks the line thickness in legend
      keywidth = 1.2,                   # Optional: controls horizontal length of legend lines
      keyheight = 0.3                   # Optional: controls vertical spacing
    ),
