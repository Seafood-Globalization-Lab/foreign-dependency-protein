...
They however, do not contain information on the food sourcing (e.g., method of capture, production origin) [@elmadfa_importance_2010; @gephart_environmental_2021].
Seafood, which contributes to 15% of globally consumed animal protein [@fao_state_2024], has broad measurements in the FAO-FBS on its apparent consumption, but not disaggregated by source, which is important for constructing representative food-based dietary guidelines.
...
Globally, ~15% of seafood contributes to consumed animal proteins.
