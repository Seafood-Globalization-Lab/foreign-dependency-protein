...
# Calculate aggregate aquatic animal protein reliance from new FBS
...
# Join on protein consumption estimates to reliance datasets
...
# Combine old / new FBS for the aggregate aquatic reliance dataset
...
#######################################
###    AQUATIC RELIANCE DATASET     ###
#######################################

# Disaggregate FAO animal protein reliance data
...
# Result: Countries that do not add up to one are only countries that that include the terrestrial reliance
...
# Check for NA values in aquatic reliance source dataset
...
# Look at attributes of aquatic food only from the reliance dataset
summary(fao_aquatic_reliance_source %>%
          filter(food_group == "aquatic"))
...
nrow_start <- fao_aquatic_reliance_source %>%
  nrow()
nrow_end <- fao_aquatic_reliance_source %>%
...
# Global values
df <- fao_aquatic_reliance_source %>%
...
keep <- c("fao_aquatic_source", "fao_aquatic_reliance_source", "population_fao_wb") # Keep only output files in env
...
# Write aquatic reliance source file to csv
write.csv(fao_aquatic_source,
          "../output/fao_fbs_aquatic_source.csv", row.names = FALSE)
 
# # Write aquatic reliance data to csv
write.csv(fao_aquatic_reliance_source,
          "../output/fao_aquatic_reliance_source.csv", row.names = FALSE)
