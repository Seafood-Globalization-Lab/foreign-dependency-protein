...
```{r}
# add some tests to make sure ti 

# error is only associated with trade (i.e., foreign) also whne source ocuntry is listed as unknown
# make 
# 5 different hs versions associated with a year
# Select one hs version and one year, or leave hs version as a grouping variable
