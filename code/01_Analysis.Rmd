...
# Laptop folder
db_folder <- "C:/Users/cjqui/Desktop/SGL/Data/ARITS_1.1.0_FAO_2025_08_02"
...
# Result: Lesotho doesn't add up to 1 from 2002 and 2003.
# This is, however not a problem with proportions not adding up, 
# It's that ARTIS contains no consumption data during these years,
# so the only years getting added up are Lesotho's terrestrial prop animal
# protein. Anything disaggregated will be NA
if(nrow(test) > 0){
...
paste0("Check to see if the joining population does not add any rows: ", nrow_start - nrow_end == 0) 
